...
function BookingDetails(props) {
	...
	return (
		<div className="booking-details">
			<Typography.Title className="title">Ticket Details</Typography.Title>
			<div className="details">
				<table>
					<tbody>
						...
						<tr>
							<td className="details-title">Payment:</td>
							<td className="details-des" style={{ color: "red" }}>Pay with cash</td>
						</tr>
						<tr>
